const nameInStorage = () => {
    ...
    header.insertAdjacentHTML("beforeend", `
      <div>
        <button class = 'header__btn'>Войти в аккаунт</button>
      </div>
    `)
    ...
    if (localStorage.length != 0) {
      ...
      <div class = "userName">
        ...
        const modalName = document.querySelector('.modal__user');
...
const burgerFunc = () => {
    ...
    const menuList = document.querySelectorAll('.header-menu__list');
